...
export(peakTFBS, type="narrowPeak", filename=paste(opt$peakFileLoc, "/", chipname, "_", inputname, ".peakTFBS.narrow.txt", sep=""))
export(peakTFBS, type="broadPeak", filename=paste(opt$peakFileLoc, "/", chipname, "_", inputname, ".peakTFBS.broad.txt", sep=""))
