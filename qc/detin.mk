...
detin/$1_$2/$1.hets4detin.tsv : gatk/dbsnp/$1.gatk_snps.vcf
	$$(call RUN,1,$$(RESOURCE_REQ_LOW_MEM),$$(RESOURCE_REQ_VSHORT),$$(BCFTOOLS_MODULE) $$(SNP_EFF_43_MODULE),"\
