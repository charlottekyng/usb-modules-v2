...
parser.add_argument('--exome', default=False, help='if the exome renormalized COSMIC signatures will be used')
...
parser.add_argument('--export_probabilities', default=True, help='Defines if the probability matrices per mutation for all samples are created. Only available when input_type is "vcf".')
parser.add_argument('--export_probabilities_per_mutation', default=True, help='Defines if the probability matrices per mutation for all samples are created. Only available when input_type is "vcf".')
parser.add_argument('--make_plots', default=True, help='Toggle on and off for making and saving plots.')
