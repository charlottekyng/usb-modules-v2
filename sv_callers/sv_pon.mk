...
sv_pon : gridss_ref $(patsubst %,gridss/pondir/%.normal.vcf, $(PANEL_OF_NORMAL_SAMPLES)) gridss_pon_beds
...
gridss_ref:
	...
	$(GRIDSS) gridss \
	-s setupreference \
	-r $(REF_FASTA) && mkdir -p gridss_ref")

# Main function to run gridss on panel of normals
define gridss-pon
gridss/pondir/%.normal.vcf : bam/%.bam gridss_ref
	$$(call RUN,1,$$(RESOURCE_REQ_HIGH_MEM),$$(RESOURCE_REQ_MEDIUM),$$(SINGULARITY_MODULE),"\
	$$(GRIDSS) gridss \
