...
fusion_ts/coverageAnalysis/$1/$1.amplicon.cov.xls : bam/$1.bam
	...
	$$(TS_IMG) /TS/plugin/coverageAnalysis/run_coverage_analysis.sh -ag -D ./fusion_ts/coverageAnalysis/$1 -B $$(TARGETS_FILE_INTERVALS) /scicore/home/pissal00/GROUP/ref_nobackup/genomes/hg19_ionref.fasta $$<")

fusion_ts/coverageAnalysis/$1/$1.amplicon.cov.xls.out : fusion_ts/coverageAnalysis/$1/$1.amplicon.cov.xls
...
fusion_ts/Fusions.txt : $(foreach sample,$(SAMPLES),fusion_ts/coverageAnalysis/$(sample)/$(sample).amplicon.cov.xls.out)
