...
HIGH_DEPTH_BED = /mnt/longterm/ng_piscuoglio/data/pnrr_pdac_wgs/brass_files/merged/depth_mask.bed
...
BRASS_OPTS = -g $(REF_FASTA) -s HUMAN -as 38 -pr $(BRASS_PROTOCOL) -gc $(GENOME_CACHE) -d $(HIGH_DEPTH_BED)
