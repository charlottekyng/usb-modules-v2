...
#	$$(call RUN,1,$$(RESOURCE_REQ_HIGH_MEM),$$(RESOURCE_REQ_SHORT),$$(JAVA8_MODULE),"\
#	$$(call GATK,CombineVariants,$$(RESOURCE_REQ_HIGH_MEM_JAVA)) --reference_sequence $(REF_FASTA) \
#	-minN $$(PON_MIN_SAMPLES) --setKey \"null\" --filteredAreUncalled --filteredrecordsmergetype KEEP_IF_ANY_UNFILTERED \
#	$$(foreach normal,$$(PANEL_OF _NORMAL_SAMPLES),--variant mutect2/chr_vcf_pon/$$(normal).$1.mutect2.vcf) \
#	--intervals $1 --out $$@")
#endef
#$(foreach chr,$(CHROMOSOMES), \
...
define mutect2-pon-chr
mutect2/chr_vcf_pon/$1.$2.mutect2.vcf.gz : bam/$1.bam
	$$(MKDIR) mutect2/chr_vcf_pon; \
	$$(call RUN,1,$$(RESOURCE_REQ_HIGH_MEM),$$(RESOURCE_REQ_LONG),$$(GATK40_MODULE),"\
	$$(call GATK40,Mutect2,$$(RESOURCE_REQ_HIGH_MEM_JAVA)) \
