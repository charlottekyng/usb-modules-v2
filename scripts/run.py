...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--log_file', default=None, help='log file - both STDOUT and STDERR should go here')
    ...
    if args.local or (args.internet and args.cluster_engine != 'lsf'):
        ...
        qsub_args += " -l membycore={hard_mem},runtime={walltime}".format(hard_mem=args.hard_memory, 
        																walltime=args.walltime)
        my_job = job.SGEJob(job_script=job_script, qsub_args=qsub_args, out_file=args.out_file,
